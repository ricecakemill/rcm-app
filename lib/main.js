        ...
        if (owner !== undefined) {
            ...
            if (firstcomeAirdropBalance.gte(airdropAmount)) {
                ...
                if (dropped === true) {
                    ...
                    firstcomeAirdropEvent.empty().append((0, skynode_1.el)("h5", "★☆ 선착순 에어드롭 이벤트 진행중! ☆★"), (0, skynode_1.el)("a", "에어드롭 받기", {
                        click: async () => {
