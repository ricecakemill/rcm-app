...
(async () => {
    ...
    skynode_1.BodyNode.append((0, skynode_1.el)("h1", "떡방앗간.닷컴"), (0, skynode_1.el)("p", "한국인의 정과 훈훈한 인심. 따뜻한 코인 커뮤니티 떡방앗간 코인 이야기. \n", (0, skynode_1.el)("a", "http://ricecakemill.com", {
        ...
        target: "_blank",
    })), (0, skynode_1.el)(".card", (0, skynode_1.el)("h5", "인절미 가격"), (0, skynode_1.el)("h6.price", (priceDisplay = (0, skynode_1.el)("span", "...")), " KLAY\n"), (0, skynode_1.el)("h5", "에어드롭 물량"), (0, skynode_1.el)("h6.price", (airdropDisplay = (0, skynode_1.el)("span", "...")), " IJM\n")), (0, skynode_1.el)("h3", "클레이로 인절미 사기"), (0, skynode_1.el)("p", "인절미를 살때도 떡크노믹스 때문에 10%를 적게 받습니다."), (0, skynode_1.el)(".form", (buyInput = (0, skynode_1.el)("input", { placeholder: "KLAY 수량" }, {
        keyup: () => {
    ...
    })), (0, skynode_1.el)("h2", "떡 NFT"), (0, skynode_1.el)("p", "떡 NFT(KIP-37) 발행 예정입니다. 순수 2차 창작물로 발행되며 창작자에게 발행된 NFT를 전량 전달합니다. 떡 NFT는 Klubs가 출시되면 Klubs에 배포됩니다."), (0, skynode_1.el)("img", { src: "/images/nft/nft.jpg" }), (0, skynode_1.el)("footer", (0, skynode_1.el)("a", "트위터", {
