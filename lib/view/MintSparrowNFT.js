...
class MintSparrowNFT {
    constructor() {
        this.container = (0, skynode_1.el)(".mint-sparrow-nft-view", (0, skynode_1.el)("a", "< 뒤로가기", { click: () => ViewUtil_1.default.go("/") }), (0, skynode_1.el)("h2", "참새 NFT 만들기"), (0, skynode_1.el)("img", {
            src: "images/sparrowNFT.png"
        }), (0, skynode_1.el)(".form", this.extnameInput = (0, skynode_1.el)("input", { placeholder: "파일 확장자 (png 등, 점 빼고)" }), this.nameInput = (0, skynode_1.el)("input", { placeholder: "NFT 이름" }), this.descriptionInput = (0, skynode_1.el)("input", { placeholder: "NFT 설명" }), this.amountInput = (0, skynode_1.el)("input", { placeholder: "발행 개수 (숫자로만)" }), (0, skynode_1.el)("input", {
            type: "file",
            change: (event) => {
        ...
        })), (0, skynode_1.el)("p.danger", "* 무료 패러디물은 관계없으나, 판매를 목적으로 하는 경우는 저작권에 주의하세요."), (0, skynode_1.el)("h5", "준비 중"), (0, skynode_1.el)("p", "* 이미 발행된 NFT도 수정할 수 있도록 추후 기능 제공 예정")).appendTo(skynode_1.BodyNode);
    }
