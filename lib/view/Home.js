...
class Home {
    constructor() {
        ...
        this.container = (0, skynode_1.el)(".home-view", (0, skynode_1.el)("a.hardfork", "☆★ 하드포크 기록 및 이전 완료! 새 사이트 개발중! 7일 오후 공지 예정! ★☆", {
            click: () => {
                alert("헤헷");
                location.href = "https://twitter.com/tteokmill";
            },
        }), (0, skynode_1.el)("a.classic-button", "인절미 클래식", {
            ...
            target: "_blank",
        }), (0, skynode_1.el)("img", { src: "/images/game/snake.png", height: "300" }), (0, skynode_1.el)("a.game-link", (0, msg_js_1.default)("FANGAME_2_BUTTON"), {
